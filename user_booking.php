...
<!-- select place -->
<div class="content">
	<center><button class="button1"><span><a href="book_playground.php" id="a1">Play Ground </a></span></button></center><br>
	<center><button class="button1"><span><a href="book_gym.php" id="a1">Gym </a></span></button></center><br>
	<center><button class="button1"><span><a href="book_swimmingpool.php" id="a1">Swimming Pool </a></span></button></center><br>
	<center><button class="button1"><span><a href="book_basketballcourt.php" id="a1">Basketball Court </a></span></button></center><br>
	<center><button class="button1"><span><a href="book_tenniscourt.php" id="a1">Tennis Court </a></span></button></center><br>
	<center><button class="button1"><span><a href="book_badmintoncourt.php" id="a1">Badminton Court </a></span></button></center>
