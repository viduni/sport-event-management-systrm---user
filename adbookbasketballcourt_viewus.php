...
<div class="content">
<div class="container">
  <h1>Booking Events of Basketball Court</h1><br>
   <button type="submit" class="btn  button" name="submit"><a href="book_basketballcourt.php" id="a1">Back to Form</a></button>
   <br><br>
  <table class="table table-bordered">
	...
	<?php
	include 'dbh.php';
	$sql="SELECT * from admin_basketballcourt ORDER BY dateOF ASC";
	$view = $conn->query($sql);
