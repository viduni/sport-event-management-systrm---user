...
<div class="container">
	<h2>Book Swimming Pool<h2>
	<form class="form-horizontal" action="inuser_swimmingpool.php" method="POST">
	...
	<div class="form-group">        
      <div class="col-sm-offset-4 col-sm-10">
		...
		<button type="submit" class="btn  button" name="view_book"><a href="adbookswimmingpool_viewus.php" id="a1">View Booking</a></button>
