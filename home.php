...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card-2">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="unievent_view.php" class="w3-bar-item w3-button" id="a1">UniversityEvents</a>
      <a href="interunievnt_view.php" class="w3-bar-item w3-button" id="a1">InterUniversityEvents</a>
	   <a href="newsFeed_view.php" class="w3-bar-item w3-button" id="a1">NewsFeed</a> 
	   <a href="user_booking.php" class="w3-bar-item w3-button" id="a1">Booking</a>
