...
<div class="container">
	...
	<form class="form-horizontal" action="inuser_badmintoncourt.php" method="POST">
	...
	<div class="form-group">        
      <div class="col-sm-offset-4 col-sm-10">
		...
		<button type="submit" class="btn  button" name="view_book"><a href="adbookplayground_viewus.php" id="a1">View Booking</a></button>
